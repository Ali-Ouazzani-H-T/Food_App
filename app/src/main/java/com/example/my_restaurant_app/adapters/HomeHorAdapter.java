package com.example.my_restaurant_app.adapters;
...
public class HomeHorAdapter extends RecyclerView.Adapter<HomeHorAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.home_horizental_item,parent,false));
    }
        ...
        if(check) {
            ...
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        ArrayList<HomeVerModel> homeVerModels = new ArrayList<>();
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich1,"Sandwitch 1","10:00-23:00","4.9","Min - $34"));
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich2,"Sandwitch 2","10:00-23:00","4.9","Min - $34"));
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich3,"Sandwitch 3","10:00-23:00","4.9","Min - $34"));
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich4,"Sandwitch 4","10:00-23:00","4.9","Min - $34"));
